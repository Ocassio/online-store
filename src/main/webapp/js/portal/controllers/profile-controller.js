portalControllers.controller("ProfileController", function($rootScope, $scope, $state, user) {
    ...
    $scope.updateProfile = function(form) {
        ...
        user.update(form.email.$modelValue, form.name.$modelValue, form.surname.$modelValue, form.address.$modelValue).success($scope.onUpdate.bind(this, form));
    };
